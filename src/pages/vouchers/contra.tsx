...
export default function ContraVoucher() {
  ...
  async function loadData() {
    try {
      ...
      const [ledgersData, nextNumber] = await Promise.all([
        ...
        voucherService.getNextVoucherNumber(companyId, "Contra")
      ]);
  ...
  return (
    <>
      <SEO title="Contra Voucher - Tally Prime" />
      ...
      <div className="min-h-screen bg-background">
        <div className="tally-header px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-bold">Contra Voucher</h1>
            <span className="text-sm opacity-80">(Bank-to-Bank Transfers)</span>
          </div>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4 mb-6">
                <div className="grid grid-cols-12 gap-2 text-sm font-semibold text-muted-foreground">
                  <div className="col-span-5">Bank/Cash Account</div>
