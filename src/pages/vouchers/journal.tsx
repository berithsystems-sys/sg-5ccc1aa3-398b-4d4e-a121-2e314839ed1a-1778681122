...
export default function JournalVoucher() {
  ...
  async function loadData() {
    try {
      ...
      const [ledgersData, nextNumber] = await Promise.all([
        ...
        voucherService.getNextVoucherNumber(companyId, "Journal")
      ]);
  ...
  return (
    <>
      <SEO title="Journal Voucher - Tally Prime" />
      ...
      <div className="min-h-screen bg-background">
        <div className="tally-header px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-bold">Journal Voucher</h1>
            <span className="text-sm opacity-80">(Adjustments & Corrections)</span>
          </div>
